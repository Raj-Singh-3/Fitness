...
//           <p>{isSignUp ? "Sign in to stay connected." : "Create an account to join us."}</p>
//           <button className="toggle-button" onClick={toggleForm}>
//             {isSignUp ? "Sign In" : "Sign Up"}
//           </button>
//         </div>
//         <div className="right-panel">
//           <form className="auth-form" onSubmit={!isSignUp ? handleSignIn : undefined}>
...
// export default AuthPage; // Default export
